    ...
    public class IspAdjustmentGUIController : UnityEngine.MonoBehaviour
    {
        ...
        public void drawGUI()
        {
            ...
            else
            {
                ...
                if (windowOpen)
                    windowPos = GUILayout.Window(250, windowPos, MainWindow, "Kerbal Isp Difficulty Scaler v1.3.4", GUILayout.Width(800), GUILayout.Height(465), GUILayout.ExpandWidth(false));
            }
        }
